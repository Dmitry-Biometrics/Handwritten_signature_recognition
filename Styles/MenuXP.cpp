...
// 9 Jul 2003 begin mods Kris Wojtas
///////////////////////////////////////////////////////////////////////////////
	static BOOL bGradient=AfxGetApp()->GetProfileInt(_T("MenuXP"), _T("ShowGradient"), TRUE);
	static BOOL bGradientSel=AfxGetApp()->GetProfileInt(_T("MenuEx"), _T("ShowGradientSel"), TRUE);
	static COLORREF crGradientStart=AfxGetApp()->GetProfileInt(_T("MenuXP"), _T("GradientStart"), RGB(0xB4, 0xC4, 0xE4));
	static COLORREF crGradientEnd=AfxGetApp()->GetProfileInt(_T("MenuXP"), _T("GradientEnd"), RGB(0xFF, 0xFF, 0xFF));
...
////////////////////////////////////////
		...
		{
			static int nGradientWidth=AfxGetApp()->GetProfileInt(_T("MenuXP"), _T("GradientWidth"), IMGWIDTH+IMGWIDTH-2);
